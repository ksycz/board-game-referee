...
QUICK_REFERENCE_MAX_CHUNKS = int(os.getenv("QUICK_REFERENCE_MAX_CHUNKS", "200"))
QUICK_REFERENCE_TIMEOUT_SECONDS = float(os.getenv("QUICK_REFERENCE_TIMEOUT_SECONDS", "30"))
